...
<body>
<%
	int sel = 1;	//1:짜장면 2:짬뽕 3:탕수육 4:팔보채 5: 유산슬
	pageContext.setAttribute("sel", 2);
	...
	case 5: out.print("유산슬 주문"); break;
	default : out.print("음식을 주문하세요"); 
	}
%>
<hr>
	<c:choose>
...
<hr>
	<%
		String[] menu = {"짜장면", "짬뽕", "탕수육", "팔보채", "유산슬"};
